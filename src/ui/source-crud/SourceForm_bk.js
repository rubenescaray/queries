...
import { sourceService, catalogService, categoryService } from '../../services/Services';
...
class SourceForm extends Component {
  constructor(props) {
    super(props);
    this.sourceFormStore = new SourceFormStore(sourceService, catalogService, categoryService, this.props.snackBarStore);
      ...
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
          <Paper style={styles.infoCard}>
              ...
              <div style={{ ...styles.iconAndTitle, width: '99%' }}>
                ...
                <div style={{ marginLeft: '20px', width: '100%' }}>
                  <TextField
                    ...
                    inputStyle={{ ...styles.sourceName, marginTop: '-10px' }}
            ...
            {/*Aqui empieza segmento de filtros*/}
              ...
              <Tabs inkBarStyle={{ background: Palette.palette.primaryDark }}>
                <Tab label="Filtros" style={{ backgroundColor: Palette.palette.primaryLight, color: '#FFF' }}>
                  <WrapperFilterContent style={{ ...styles.filterContent, justifyContent: 'space-evenly' }}>
                    ...
                    <div style={{ width: '13.66%', display: 'flex', alignItems: 'center', flex: '1 0 auto' }}>
                      <Checkbox
                        label="Permitir nulo"
            ...
            {/*Aqui termina segmento de filtros*/}
            <div>
